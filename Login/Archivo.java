...
public class Archivo {
    ...
    public void crear(String usr,String pass){
          FileReader fr = null;
            try {
                ...
                String linea;
                sc = new Scanner(new File("Ubicacion" + "/BD.txt"));
                File f = new File("Ubicacion" + "/BD.txt");
                fr = new FileReader(f);
    ...
    public void agregar(String usr,String pass) throws IOException{
       FileWriter  fw = null; 
       PrintWriter pw = null;
       
       try{
           fw = new  FileWriter("Ubicacion" + "/BD.txt");
